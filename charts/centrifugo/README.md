...
| `service.separateServices`                  | Separate services(for avito internal politics)                                                                          | `false`                                                      |
| `internalService.enabled`                   | enable internal (for API, Prometheus metrics, admin web interface, health checks) port service                          | `true`                                                       |
...
| `grpcService.enabled`                       | enable GRPC API port service                                                                                            | `false`                                                      |
